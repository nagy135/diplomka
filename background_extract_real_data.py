...
for i in range(8,9):
    input_file = 'data/M27_R_60s-001.fit'
    ...
    extracted_background_2 = sigma_clipper(result)
    result_2 = image-extracted_background_2

    show_3d_data(image, method='matplotlib')
    show_3d_data(extracted_background, method='matplotlib')
    show_3d_data(extracted_background_2, method='matplotlib')
    show_3d_data(result, method='matplotlib')
    show_3d_data(result_2, method='matplotlib')

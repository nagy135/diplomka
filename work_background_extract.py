...
label = 'iter-' + num_iterations + '_deviation-' + deviation + '_sigmathreshold-' + sigma_threshold + '_finalblur-' + final_blur
export_folder = 'At_home_all'
for i in range(1,10):
    input_file = 'generated/Comb_' + str(i) + '/Comb/Comb_' + str(i) + '.fits'
    image = read_fits_file(input_file)

    original_background_input_file = 'generated/Comb_' + str(i) + '/Noise/Noise_' + str(i) + '.fits'
    ...
    edit_fits_data(input_file, extracted_background, file_name+ '_' + label + '_bg.'+extension, export_folder + '/')

    edit_fits_data(input_file, difference_between_backgrounds, file_name+ '_' + label  + '_difference_bgs.'+extension, export_folder + '/')
    ...
    edit_fits_data(input_file, result, file_name+ '_' + label + '_result.'+extension, export_folder + '/')

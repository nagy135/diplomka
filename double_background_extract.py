...
for i in range(1,10):
    ...
    edit_fits_data(input_file, extracted_background, file_name+'_15x15.'+extension, 'Smoothing/')

    edit_fits_data(input_file, difference_between_backgrounds, file_name+'_15x15_difference_bgs.'+extension, 'Smoothing/')
    ...
    extracted_background2 = sigma_clipper(result)
    result2 = result-extracted_background2
    # show_3d_data(extracted_background, method='matplotlib')

    edit_fits_data(input_file, result2, file_name+'_15x15__double_sigma.'+extension, 'Smoothing/')
